...
def user_posts(username):
    ...
    # setting a variable 'page'
    # helps us to cycle through blog posts using pages.
    ...
    return render_template('user_blog_post.html', blog_posts=blog_posts, user=user, profile_image=profile_image)
